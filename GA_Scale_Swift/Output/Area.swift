...
public enum MyAreaUnit: Double {
    case 平方英尺_squareFoot = 0.092_903
    case 平方码_squareYard = 0.836_127
    case 平方米_squareMeter = 1
    case 平方千米_squareKilometer = 1_000_000
    case 平方英里_squareMile = 2_589_988.11
    case 英亩_acre = 4_046.86
    case 公顷_hectare = 10_000
